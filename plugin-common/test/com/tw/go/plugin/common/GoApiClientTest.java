...
public class GoApiClientTest {
    ...
    @Test
    public void maskPwd() {
        String s = "download https://theuser:blablubb@bitbucket.org/haufegroup/dummy-container.git and https://jenkins_build-haufe-lexware:UrH&uRJ4+Xb9@bitbucket.org/haufegroup/dummy-container.git to me.";
        s = s.replaceAll("(?<=://)[^:@]+(:[^@]+)?(?=@)","*******");
